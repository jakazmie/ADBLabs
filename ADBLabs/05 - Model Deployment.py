...
resource_group = "jkamllab"
workspace_name = "jkamllab"
...
model_local = 'file:' + os.getcwd() + '/' + model_path
...
# MAGIC %sh
# MAGIC 
# MAGIC ls -la models/bike_regression
...
mymodel = Model.register(model_path=model_path, 
                         model_name='BikeRegressionSparkML',
